...
class Cashflow_mandiri extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            'title'   => 'CASHFLOW BANK MANDIRI ' . $from . ' ' . $to,
            'page'    => 'cashflow_mandiri/main',
            'vitamin' => 'cashflow_mandiri/main_vitamin',
            'from'    => $from,
            'to'      => $to,
            'list'    => $list,
        );
    ...
    public function add()
    {
        ...
        $data = array(
            'title'    => 'TAMBAH CASHFLOW BANK MANDIRI',
    ...
    /* End of file  Cashflow_mandiri.php */
