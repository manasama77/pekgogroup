...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                <form action="<?= base_url('supplier/index'); ?>" method="post">
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="NAMA SUPPLIER" minlength="3" maxlength="100" value="<?= set_value('name'); ?>" required>
                                <?= form_error('name'); ?>
                            </div>
                            <div class="form-group">
                                <label for="location">LOKASI</label>
                                <input type="text" class="form-control" id="location" name="location" placeholder="SUPPLIER" minlength="3" max="255" value="<?= set_value('location'); ?>" required>
                                <?= form_error('location'); ?>
                            </div>
                        </div>
