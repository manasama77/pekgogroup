    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <form action="<?= base_url('setup/parameter/ukuran/' . $list->row()->id); ?>" method="post">
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="NAMA UKURAN" minlength="1" maxlength="10" value="<?= (set_value('name')) ? set_value('name') : $list->row()->name; ?>" required>
                                <?= form_error('name'); ?>
                            </div>
                        </div>
                        <div class="card-body">
