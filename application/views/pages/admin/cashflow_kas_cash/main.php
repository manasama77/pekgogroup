                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-sm bg-light">
                                <caption>Data Cashflow Kas Cash</caption>
                                    ...
                                    <?php } else { ?>
                                        <?php for ($i = 0; $i < count($list['data']); $i++) { ?>
                                            <tr>
                                                ...
                                                <td class="text-right">Rp. <?= $list['data'][$i]['debet']; ?></td>
                                                <td class="text-right">Rp. <?= $list['data'][$i]['kredit']; ?></td>
                                                <td class="text-right <?= ($list['data'][$i]['total'] < 0) ? "text-danger" : "text-black"; ?>"><strong>Rp. <?= $list['data'][$i]['total']; ?></strong></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                </tbody>
