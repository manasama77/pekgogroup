...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                <form action="<?= base_url('setup/parameter/satuan'); ?>" method="post">
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="NAMA SATUAN" minlength="1" maxlength="10" value="<?= set_value('name'); ?>" required>
                                <?= form_error('name'); ?>
                            </div>
                        </div>
