        ...
        <form id="form_barang">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="kategori_id" name="kategori_id" autocomplete="off" data-placeholder="Pilih Kategori" required>
                                    ...
                                    <?php foreach ($categories->result() as $category) { ?>
                                        <option value="<?= $category->id; ?>" <?= ($category->id == $old_data['kategori_id']) ? "selected" : null; ?>><?= $category->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="name">Nama Barang</label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama Barang" minlength="3" maxlength="255" autocomplete="off" value="<?= $old_data['name']; ?>" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="merk_id" name="merk_id" data-placeholder="Pilih Merk" autocomplete="off" required>
                                    ...
                                    <?php foreach ($merks->result() as $merk) { ?>
                                        <option value="<?= $merk->id; ?>" <?= ($merk->id == $old_data['merk_id']) ? "selected" : null; ?>><?= $merk->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="color_id" name="color_id" data-placeholder="Pilih Warna" autocomplete="off" required>
                                    ...
                                    <?php foreach ($colors->result() as $color) { ?>
                                        <option value="<?= $color->id; ?>" <?= ($color->id == $old_data['color_id']) ? "selected" : null; ?>><?= $color->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="unit_id" name="unit_id" data-placeholder="Pilih Satuan" autocomplete="off" required>
                                    ...
                                    <?php foreach ($units->result() as $unit) { ?>
                                        <option value="<?= $unit->id; ?>" <?= ($unit->id == $old_data['unit_id']) ? "selected" : null; ?>><?= $unit->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12 mb-4 mt-4">
                    <input type="text" id="barang_id" name="barang_id" value="<?= $barang_id; ?>" />
