<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">TAMBAH CASHFLOW BANK BCA</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="row">
        <div class="col-12 mb-3">
            <a href="<?= base_url('cashflow_bca/index'); ?>" class="btn btn-secondary btn-lg btn-block btn-flat"><i class="fas fa-backward fa-fw"></i> Kembali Ke List Cashflow Bank BCA</a>
        </div>
    </div>
</div>