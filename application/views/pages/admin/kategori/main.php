...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                <form action="<?= base_url('setup/parameter/kategori'); ?>" method="post">
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="NAMA KATEGORI" minlength="3" maxlength="100" value="<?= set_value('name'); ?>" required>
                                <?= form_error('name'); ?>
                            </div>
                        </div>
...
<!-- Modal -->
<form id="form_edit" action="<?= base_url('setup/parameter/kategori/update'); ?>" method="post">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="xname">NAMA KATEGORI</label>
                            <input type="text" class="form-control" id="xname" name="xname" placeholder="NAMA KATEGORI" minlength="3" maxlength="100" required>
                        </div>
                    </div>
                </div>
